...
if ( ! function_exists( 'speedcreed_themes_setup' ) ) :
	/**
	 ...
	 */
	function speedcreed_themes_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Speedcreed Themes, use a find and replace
		 * to change 'speedcreed-themes' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'speedcreed-themes', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'speedcreed-themes' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'speedcreed_themes_custom_background_args', array(
...
add_action( 'after_setup_theme', 'speedcreed_themes_setup' );
